...
function getDefaultRateForJobType(typeName) {
  const defaults = getJobTypeDefaults(typeName);
  return defaults.defaultRate || 0;
}
...
function jobTypeChanged(sel, skip = false) {
  ...
  const hrs = block.querySelector('.job-hours');
